...
import type { SuggestShelfLocationOutput } from '@/types';
...
export default function OptimizeShelfPage() {
  const [isLoading, setIsLoading] = useState(false);
  const [suggestion, setSuggestion] = useState<SuggestShelfLocationOutput | null>(null);
